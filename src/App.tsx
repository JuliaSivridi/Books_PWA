...
import { checkBooksFile, createBooksFile, setSheetFile } from './services/drive'
...
function SetupScreen({ onDone }: { onDone: () => void }) {
  ...
  async function handleCreate() {
    ...
    try { await createBooksFile(); onDone() }
  ...
  return (
    <div className={styles.splash}>
      ...
      <p style={{ opacity: .7, maxWidth: 320, textAlign: 'center', lineHeight: 1.45, fontSize: '.95rem' }}>
        Books stores your library in a Google Sheets file in your Drive.
        Create a new one, or pick an existing spreadsheet (e.g. your db_books).
      </p>
